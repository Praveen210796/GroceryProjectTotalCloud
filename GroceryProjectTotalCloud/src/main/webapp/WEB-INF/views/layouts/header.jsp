	...
	<meta name="keywords" content="TotalCloudGeneral Store, TotalCloud Store, General Store, Gokuldham Society, TotalCloud General Store Bangalore, Shop no.4, Grocery Shop" />
	<script>
